...
public class RepreController extends EntityController {
    
    private static RepreController repreControler;
    ...
    public RepreController() {
        this.reglas = new ArrayList<Regla>();
        this.predicados = new ArrayList<Predicado>();
    }

    public static RepreController getInstance() {
        if (repreControler == null) {
            repreControler = new RepreController();
        }
